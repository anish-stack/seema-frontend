...
<footer className="bg-white border-t mt-5 dark:bg-gray-900">
    <div className="mx-auto w-full p-5 ">
      ...
      <div>
        ...
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                    <a href="/Shipping-Policy" className="hover:underline">Terms And Condition</a>
                </li>
                <li className="mb-4">
    ...
    <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2024 <a href="https://digiindiasolutions.com/">Seema Collections By Neetuy</a>. All Rights Reserved.
        </span>
